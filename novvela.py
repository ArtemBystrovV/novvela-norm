...
def main():
    ...
    print(f"Вы очнулись в плохо освещённом тунеле, {player_name}!")

    load_game_data()

    print("Приядя в себя и немного  подумав вы решаете пойти.")
    print("1. Вперёд\n2. Назад\n3. Зайти в странную дверь справа")
...
def forestgump():
    print("Вы пошли вперёд.")
    print("1. Ещё одно странная дверь.\n2. Пойти дальше")
